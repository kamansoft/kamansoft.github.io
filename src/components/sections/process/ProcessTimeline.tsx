...
// Following SRP - Only responsible for rendering timeline
...
const ProcessTimeline = ({ steps, totalDuration }: ProcessTimelineProps) => {
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <TimelineSummary totalDuration={totalDuration} />
    </div>
  );
};

// Following SRP - Single responsibility for rendering a step
...
// Following SRP - Single responsibility for summary
const TimelineSummary = ({ totalDuration }: { totalDuration: string }) => (
